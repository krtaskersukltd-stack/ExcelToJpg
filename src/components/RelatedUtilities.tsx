        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {utilities.map((item, idx) => (
            <motion.div
              ...
              className="cursor-pointer group rounded-2xl p-5 bg-[#F9FBFE] hover:bg-[#F0F6FE] border border-blue-100/80 shadow-xs hover:shadow-md hover:shadow-blue-500/10 hover:border-blue-300/80 transition-all duration-200 flex items-center justify-between gap-4"
            >
