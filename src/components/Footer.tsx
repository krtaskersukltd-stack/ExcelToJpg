...
export default function Footer() {
  return (
    <footer className="bg-[#FAFBFD] pt-16 pb-12 relative overflow-hidden border-t border-slate-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Main Footer Container Card */}
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/90 shadow-[0_4px_30px_-5px_rgba(15,23,42,0.04)]">
            ...
            <div className="md:col-span-5 space-y-4">
              <Link href="/" className="inline-block group">
                <Image
                  ...
                  width={76}
                  height={117}
                  className="h-12 w-auto object-contain drop-shadow-xs group-hover:scale-105 transition-transform"
                />
              </Link>
        ...
        {/* Giant Watermark Typography matching the bottom of Figma */}
        <div className="mt-14 text-center select-none pointer-events-none">
          <span className="text-5xl sm:text-7xl md:text-8xl lg:text-[110px] font-black tracking-tight text-blue-600/20 bg-clip-text text-transparent bg-gradient-to-b from-blue-600/30 to-blue-500/5">
            Excel To JPG
          </span>
        </div>
