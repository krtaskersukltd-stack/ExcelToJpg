        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 lg:gap-8">
          {cards.map((card, idx) => (
            <motion.div
              ...
              className="relative rounded-[28px] p-6 sm:p-7 bg-[#FAFBFD] border border-indigo-100/80 shadow-[0_10px_30px_-5px_rgba(59,130,246,0.07),0_2px_8px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_45px_-8px_rgba(59,130,246,0.14)] hover:-translate-y-1.5 transition-all duration-300 flex flex-col items-center"
            >
